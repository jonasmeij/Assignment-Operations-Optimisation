...
from Visualization import visualize_routes, visualize_schedule_random
import random
...
def random_generation_containers(nodes, node_coords, buffer_time=24*60):
    container_amount = 600  # Number of containers to generate
    containers_data = []
...
def construct_network():
    ...
    nodes = {
        ...
        1: Node(1, 'depot'),  # Another Inland Depot (e.g., Tilburg Depot)
        2: Node(2, 'depot'),  # Another Inland Depot (e.g., Eindhoven Depot)
        3: Node(3, 'depot'),  # Another Inland Depot (e.g., Nijmegen Depot)
        4: Node(4, 'depot'),  # Another Inland Depot (e.g., Utrecht Depot)
        ...
        26: Node(26, 'depot_arr'),  # Dummy arrival for Another Inland Depot
        27: Node(27, 'depot_arr'),  # Dummy arrival for Another Inland Depot
        28: Node(28, 'depot_arr'),  # Dummy arrival for Another Inland Depot
        29: Node(29, 'depot_arr')   # Dummy arrival for Another Inland Depot
    }
    ...
    node_coords = {
        ...
        # Terminals (Port of Rotterdam Area)
    ...
    HT = {1: 200}  # You can add more truck IDs and their costs if needed
...
def barge_scheduling_problem(nodes, arcs, containers, barges, truck, HT, node_coords,depot_to_dummy):
    ...
    L = 10      # Handling time per container in hours (e.g., loading/unloading time)
    gamma = 25 # Penalty cost for visiting sea terminals
    ...
    model.setParam('TimeLimit', 500)      # Set a time limit of 5 minutes (300 seconds)
